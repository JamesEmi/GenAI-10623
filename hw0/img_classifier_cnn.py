...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(64 * 64 * 64, 512) # Adjust the input features to match the output of the last maxpool
...
def main(n_epochs, batch_size, learning_rate):
    ...
    for t in range(n_epochs):
        ...
        evaluate(test_dataloader, "Test", model, loss_fn, t)
        evaluate(val_dataloader, "Val", model, loss_fn, t)
